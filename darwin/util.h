 ...
 *  @return The new list
 */
CLINK_DARWIN_EXPORT OCL_List *ocl_list_create(void);
 ...
 */
CLINK_DARWIN_EXPORT void ocl_list_destroy(OCL_List *list);
 ...
 */
CLINK_DARWIN_EXPORT void ocl_list_clear(OCL_List *list);
 ...
 */
CLINK_DARWIN_EXPORT void ocl_list_empty(OCL_List *list);
 ...
 */
CLINK_DARWIN_EXPORT void ocl_list_clear_destroy(OCL_List *list);
 ...
 */
CLINK_DARWIN_EXPORT void ocl_list_push(OCL_List *list, void *value);
 ...
 */
CLINK_DARWIN_EXPORT void *ocl_list_pop(OCL_List *list);
 ...
 */
CLINK_DARWIN_EXPORT void ocl_list_unshift(OCL_List *list, void *value);
 ...
 */
CLINK_DARWIN_EXPORT void *ocl_list_shift(OCL_List *list);
 ...
 */
CLINK_DARWIN_EXPORT void *ocl_list_remove(OCL_List *list, OCL_ListNode *node);
 ...
 */
CLINK_DARWIN_EXPORT int ocl_list_bubble_sort(OCL_List *list,
                                             ocl_list_compare_cb cmp);

CLINK_DARWIN_EXPORT OCL_List *ocl_list_merge_sort(OCL_List *list,
                                                  ocl_list_compare_cb cmp);
